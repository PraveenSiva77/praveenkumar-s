      ...
      <div className='w-full mx-auto flex items-center justify-center p-12 mb-24'>
        ...
        <form class="max-w-sm mx-auto w-full flex flex-col items-center gap-2">
          ...
          <div class="flex items-start my-5">
            ...
            <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <Link to="/terms-conditions" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</Link></label>
          </div>
