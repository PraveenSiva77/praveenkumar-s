...
function GotoButton({value}) {
  ...
  return (
    ...
    className='z-50 border border-text-light dark:text-text-dark mdx:border-none hover:border-primary-light hover:text-primary-light dark:hover:text-primary-light px-3 py-1 rounded-full'>
        <span 
